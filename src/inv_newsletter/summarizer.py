...
# _record_usage, _estimate_tokens_from_text, _format_cost_report, _run_usage).
# _run_usage is mutated in place (.clear()/.append()/slice reads) so the
# imported name stays bound to the same list object as cost._run_usage.
